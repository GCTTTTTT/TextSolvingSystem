	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/res/progressbar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/res/progressbar/progressbg_red.gif',
									30: '/res/progressbar/progressbg_orange.gif',
									70: '/res/progressbar/progressbg_green.gif'
								},
